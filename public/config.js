...
const WORKER_WS = WORKER_URL.replace(/^https?/, match => match === ‘https’ ? ‘wss’ : ‘ws’);
  ...
  mediterranean: { label: 'Mediterranean', center: [37, 15], zoom: 5, bbox: '30,-6,47,42' },
  persian_gulf: { label: 'Persian Gulf', center: [25, 54], zoom: 6, bbox: '22,48,30,62' },
  southeast_asia: { label: 'SE Asia', center: [3, 104], zoom: 5, bbox: '-5,95,15,120' },
  us_east: { label: 'US East Coast', center: [35, -75], zoom: 5, bbox: '24,-85,47,-65' },
  us_west: { label: 'US West Coast', center: [37, -122], zoom: 5, bbox: '32,-130,50,-115' },
};
const APP_CONFIG = {
